...
public class do_Work
{
    ...
    public List<(int, long)> items = new();
...
string run(int rounds, Func<long, int, int, long> worry)
{
...
string part1() { return run(20, (x, y, z) => x / 3); }

string part2() { return run(10000, (x, y, z) => x % modulus); }
